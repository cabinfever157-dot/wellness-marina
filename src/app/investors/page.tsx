      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 pb-24 space-y-16">
        ...
        <FadeIn delay={0.3}>
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-10 h-full flex flex-col justify-center group hover:border-[#FFD700]/30 transition-all duration-500">
              <div className="relative z-10">
                ...
                <div className="space-y-4">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 text-sm">Federal RHTP, HRSA, USDA Rural Development — non-dilutive capital</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 text-sm">15M+ drive market generating commercial revenue from hospitality</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 text-sm">OZ tax-free appreciation + E-2 turnkey businesses + Boat Fund</p>
                    </div>
                  </div>
                </div>
              </div>
