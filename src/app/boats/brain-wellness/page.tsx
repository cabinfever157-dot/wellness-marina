...
export default function BrainWellnessPage() {
  return (
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center px-4">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <span className="text-teal-400 text-xs font-medium tracking-[0.2em] uppercase">Brain Wellness</span>
              <div className="h-px w-8 bg-teal-400/50" />
            </div>
            <h1 className="text-5xl md:text-6xl font-bold text-white">Brain Wellness Boat</h1>
            <p className="text-xl text-white mt-4 max-w-2xl mx-auto">
              A sanctuary on the water — bridging critical care gaps with evidence-based brain wellness diagnosis and treatment in a stigma-free environment.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 pb-24 space-y-16">
        ...
        <FadeIn>
          <div className="relative overflow-hidden rounded-2xl border border-teal-500/20 bg-white/25 backdrop-blur-md p-10">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <div className="mb-4">
                  <span className="bg-teal-600 text-white shadow-teal-400/50 shadow-lg px-4 py-1.5 rounded-full text-sm font-semibold tracking-wide uppercase backdrop-blur-md">Brain Wellness</span>
                </div>
                <h2 className="text-2xl font-bold text-white mb-4 text-glow-subtle">Accessible Brain Wellness Care</h2>
                <p className="text-white text-lg leading-relaxed text-glow-black">
                  The Brain Wellness Boat delivers evidence-based brain wellness diagnosis and treatment directly into rural community spaces, bringing an established network of clinicians to waterfront locations that pure home-based telehealth cannot effectively reach.
                </p>
              </div>
          ...
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/25 backdrop-blur-md">
            <div className="grid lg:grid-cols-2">
              ...
              <div className="p-10 flex flex-col justify-center">
                ...
                <p className="text-white text-lg leading-relaxed mb-6 text-glow-black">
                  A preventative wellness floor offering screening, coaching, and employer benefit programming — making brain wellness care accessible before it becomes a crisis.
                </p>
                <ul className="space-y-3 text-white text-glow-black-light">
                  ...
                  <li className="flex items-start"><span className="text-teal-400 mr-3 mt-1">✦</span> Employer benefit brain wellness programming.</li>
        ...
        <FadeIn>
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/25 backdrop-blur-md p-10">
            <h2 className="text-2xl font-bold text-white mb-8 text-center text-glow-subtle">Brain Wellness Services</h2>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                { title: "Medical Treatment", desc: "Clinical care for ADHD, anxiety, depression, and diagnostic evaluations covering up to 29 brain wellness conditions." },
          ...
          <div className="relative overflow-hidden rounded-2xl border border-teal-500/20 bg-white/25 backdrop-blur-md p-10">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-white text-lg leading-relaxed text-glow-black">
                  Every design choice on the Brain Wellness Boat is purposefully crafted to remove the stigma of seeking help. From soundproofed rooms to the absence of a traditional waiting area, the boat creates a calming, private environment where rural residents can access the care they need without judgment.
                </p>
              </div>
              <div className="relative h-64 rounded-xl overflow-hidden">
                <div
...
<h2 className="text-3xl font-bold text-white mb-4 text-glow-subtle">Wellness Starts Here</h2>
               <p className="text-xl text-white max-w-2xl mx-auto mb-8 text-glow-black">
                Access evidence-based brain wellness care in a welcoming, stigma-free environment on the water.
              </p>
