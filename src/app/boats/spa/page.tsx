          ...
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/25 backdrop-blur-md p-10">
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <div className="text-white text-sm">Treatment & Relaxation Spaces</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-rose-400 mb-2">Rooftop Deck</div>
                <div className="text-white text-sm">Open-Air Relaxation Lounge</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-rose-400 mb-2">Daily</div>
                <div className="text-white text-sm">Spa Services Available</div>
              </div>
            </div>
