...
<h3 className="text-xl font-bold text-white mb-3 text-glow-subtle">{item.title}</h3>
                 <p className="text-white text-sm leading-relaxed text-glow-black-light">{item.desc}</p>
              </div>
            ))}
          </div>
        </FadeIn>
          ...
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/25 backdrop-blur-md">
            <div className="grid lg:grid-cols-2">
              ...
              <div className="p-10 flex flex-col justify-center">
                ...
                <h2 className="text-3xl font-bold text-white mb-4 text-glow-subtle">Where Education Meets Experience</h2>
...
<h2 className="text-3xl font-bold text-white mb-4 text-glow-subtle">Premium Dining Meets Clinical Care</h2>
                 <p className="text-white text-lg leading-relaxed mb-6 text-glow-black">
...
<h2 className="text-3xl font-bold text-white mt-4 mb-4 text-glow-subtle">Where the Marina Comes Alive</h2>
               <p className="text-white text-lg max-w-2xl mx-auto text-glow-black">
        ...
        <FadeIn>
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/25 backdrop-blur-md p-10">
            <h2 className="text-2xl font-bold text-white mb-6 text-center text-glow-subtle">Impact & Partnerships</h2>
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
<div className="text-3xl font-bold text-amber-400 mb-2 text-glow-amber">4-8</div>
                 <div className="text-white text-sm text-glow-black-light">Permanent Direct Jobs Created</div>
              </div>
              <div>
<div className="text-3xl font-bold text-amber-400 mb-2 text-glow-amber">Significant</div>
                 <div className="text-white text-sm text-glow-black-light">Annual Healthcare Savings from Chronic Disease Prevention</div>
              </div>
              <div>
<div className="text-3xl font-bold text-amber-400 mb-2 text-glow-amber">Local Farms</div>
                 <div className="text-white text-sm text-glow-black-light">Partnered for USDA Rural Development qualification</div>
              </div>
            </div>
          </div>
        </FadeIn>
...
<h2 className="text-3xl font-bold text-white mb-4 text-glow-subtle">Taste the Difference</h2>
